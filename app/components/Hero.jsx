  ...
  return (
    <section className="min-h-screen relative overflow-hidden flex flex-col justify-between w-full">
      ...
      <div className="relative min-h-screen overflow-hidden">
        ...
        {/* Gold decorative elements (floating) - Using inline animations */}
        <div className="absolute top-20 -left-20 w-80 h-80 bg-amber-900/10 rounded-full blur-3xl"
             style={{animation: 'float 8s ease-in-out infinite'}}></div>
        <div className="absolute bottom-20 -right-20 w-80 h-80 bg-yellow-800/10 rounded-full blur-3xl"
        ...
        <div className="relative z-10 h-full min-h-screen flex items-center">
          <div className="max-w-7xl mx-auto px-4 py-20 md:py-32 w-full">
            <div className="max-w-2xl">
              {/* Premium Badge */}
              <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-gradient-to-r from-black/70 to-amber-900/30 rounded-full border border-amber-600/40 backdrop-blur-sm mb-8 opacity-0 animate-fadeIn"
              ...
              {/* Main Headline */}
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif mb-6 leading-tight opacity-0"
              ...
              {/* Subtitle */}
              <div className="relative mb-10 max-w-xl opacity-0"
              ...
              {/* CTA Buttons */}
              <div className="flex flex-col sm:flex-row gap-4 mb-16 opacity-0"
